<!DOCTYPE html>
<html>
<title>Raccoon Siting Data Collection</title>
<head>
     <style>
	 * {margin: 0; padding: 0;}
	 ...
	 #header {margin-left: 0; width: 100%; background-color: #B79FA6; color: #FFFFFF; 
     border-radius: 5px; padding-top: 20px; opacity: 0.5; padding-bottom: 20px;}
	 #infoBox {margin-right: 0; width: 64%; background-color: #8F787E; color: #FFFFFF; border-radius: 5px;
	     padding-top: 20px; opacity: 0.5; float: right;}
   #map {;}
	 #footer {margin-left: 0; width: 100%; background-color: #8F787E; color: #FFFFFF; 
